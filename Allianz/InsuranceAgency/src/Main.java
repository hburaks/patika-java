...
public class Main {
    public static void main(String[] args) {
        ...
        BankAccount bankAccountAgency = bankAccountService.createBankAccount("İş Bankası", "TR111111111111111111111111", BigDecimal.valueOf(100000));
        BankAccount bankAccountInsuranceCompany = bankAccountService.createBankAccount("Yapı Kredi", "TR123446541111111111", BigDecimal.valueOf(3000000));

        agencyService.addBankAccountToAgency(agency, bankAccountAgency);

        InsuranceCompany insuranceCompany = insuranceCompanyService.createInsuranceCompany("Allianz", "Mesir", "123123131", "Gaziemir - İzmir", BigDecimal.valueOf(0.08));
        ...
        Insurance insurance = insuranceService.createInsurance("Compulsory Traffic Insurance", InsuranceTypeEnum.COMPULSORY_TRAFFIC_INSURANCE);
        ...
        BankAccount bankAccountCustomer = bankAccountService.createBankAccount("Ziraat", "TR12234453543534", BigDecimal.valueOf(10000));
        customerService.addBankAccountToCustomer(customer, bankAccountCustomer);
        agencyService.addCustomerToAgency(agency, customer);

        Vehicle vehicle = vehicleService.createVehicle("Opel", "Astra", 1998, "45ALV301", "S4FG235Y6767", ColorTypeEnum.BLUE);
        ...
        customerService.addInsuranceRequestToCustomer(customer, insuranceRequest);
        Proposal proposal = proposalService.createProposal(insuranceCompany, vehicle, BigDecimal.valueOf(1500), startDate, endDate, expireDate, BigDecimal.valueOf(100));
