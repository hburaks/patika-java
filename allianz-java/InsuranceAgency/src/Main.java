...
public class Main {
    public static void main(String[] args) {
        ...
        agencyService.addBankAccountToAgency(agency,
                bankAccountAgency);
        ...
        insuranceCompanyService.addInsuranceToInsuranceCompany(insuranceCompany,
                insurance);
        insuranceCompanyService.addBankAccountToInsuranceCompany(insuranceCompany,
                bankAccountInsuranceCompany);

        Customer customer = customerService.createCustomer("Hasan Burak",
        ...
        Accident accident = accidentService.createAccident(accidentDate,
                "X car hit the tree from front",
        ...
        customerService.addInsuranceRequestToCustomer(customer, insuranceRequest);
        Proposal proposal = proposalService.createProposal(insuranceCompany,
                vehicle,
